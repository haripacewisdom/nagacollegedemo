...
#ifndef PRISM_IOS_FINGERPRINT_SDK_SWIFT_H
#define PRISM_IOS_FINGERPRINT_SDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="prism_ios_fingerprint_sdk",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface BureauAPI (SWIFT_EXTENSION(prism_ios_fingerprint_sdk)) <CLLocationManagerDelegate>
